...
public static void main(String argv[]) {
 ...
 public static void ScheduleDeparture() {
  ...
  // From d to f
  //while(( ServTime = normal(stream, MeanServiceTime,SIGMA)) < 0 );
...
System.out.println( "\tNEW AVERAGE INTER-ARRIVAL TIME              " + TotArrivalTime / TotalCustomers);
System.out.println( "\tANEW AVERAGE SERVICE TIME                    " + TotServiceTime / TotalCustomers);
}
